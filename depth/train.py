...
from models.model import EDADepth
...
def main():
    ...
    if args.rank == 0:
        ...
        if args.log_in_wandb:
            wandb.init(project='EDADepth', name ="")
    ...
    #criterion_d = IterExponential(total_iter_length=25000, final_ratio=0.01, warmup_steps=200)
